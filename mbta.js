$(document).ready( function() {    
    $.getJSON('http://developer.mbta.com/Data/Red.json', function(data) {
        var platformKeys = []
        $.map($('th.PlatformKey'), function(e) { platformKeys.push(e.id);});
        ...
        if ( tripsFromStart.length === 0) {
            $('table#timetable').after("<em>No times reported</em>")
        } else {
